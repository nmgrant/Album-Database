...
public class JDBC_GUI extends javax.swing.JFrame {
    ...
    dataTables.addKeyListener(new java.awt.event.KeyAdapter() {
        public void keyPressed(java.awt.event.KeyEvent evt) {
            dataTablesKeyPressed(evt);
        }
    });
    ...
    albumDataTable.addKeyListener(new java.awt.event.KeyAdapter() {
        public void keyPressed(java.awt.event.KeyEvent evt) {
            albumDataTableKeyPressed(evt);
        }
    });
    ...
    private void removeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeButtonActionPerformed
        JOptionPane.showMessageDialog(this, accessObject.removeAlbum((String) resultList.getSelectedValue()));
    ...
    private void resultListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_resultListMouseClicked
        ...
        if (isAlbumTab()) {
            ...
            if (resultList.isSelectedIndex(selectedAlbum)) {
                ...
                selectedStudio = resultList.getSelectedIndex();
            }
        }
    ...
    private void insertAlbumButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertAlbumButtonActionPerformed
        ...
        String result = accessObject.insertAlbum(((AlbumTableModel) albumDataTable.getModel()).getAlbum());

        if (result.equals("Insert album successful!")) {
        ...
        populateList(accessObject.listAlbumTitles());
        defaultAlbumModel = new AlbumTableModel(new ArrayList<String>(Arrays.asList("", "", "", "", "", "")));
        albumDataTable.setModel(defaultAlbumModel);
    ...
    private void insertStudioButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertStudioButtonActionPerformed
        if (resultList.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(this, "Please select a studio.");
            return;
        }

        String studio = studios[resultList.getSelectedIndex()];
        String result = accessObject.insertStudio(((StudioTableModel) studioDataTable.getModel()).getStudio(), studio);

        if (result.equals("Insert studio successful!")) {
            JOptionPane.showMessageDialog(this, result);
        ...
        defaultStudioModel = new StudioTableModel(new ArrayList<String>(Arrays.asList("", "", "", "")));
        studioDataTable.setModel(defaultStudioModel);
        populateList(accessObject.listStudioTitles());
   ...
   private void dataTablesKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_dataTablesKeyPressed
       if (evt.getKeyCode() == java.awt.event.KeyEvent.VK_F1) {
           dataTables.setSelectedIndex(0);
       } else if (evt.getKeyCode() == java.awt.event.KeyEvent.VK_F2) {
           dataTables.setSelectedIndex(1);
       }
   }//GEN-LAST:event_dataTablesKeyPressed

    private void albumDataTableKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_albumDataTableKeyPressed
        if (evt.getKeyCode() == java.awt.event.KeyEvent.VK_DELETE) {
            albumDataTable.setValueAt("", 1, albumDataTable.getSelectedColumn());
        }
    }//GEN-LAST:event_albumDataTableKeyPressed
    ...
    public void populateList(ArrayList<String> list) {
        if (list == null) {
            ...
            if (isAlbumTab()) {
                ...
                studios = list.toArray(new String[list.size()]);
            }
        }
    ...
    public void populateTable(ArrayList<String> data) {
        ...
        AlbumTableModel tableModel = new AlbumTableModel(data);
