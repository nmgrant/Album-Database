...
public class JDBC_GUI extends javax.swing.JFrame {
   ...
   pack();
    ...
    private void removeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeButtonActionPerformed
       accessObject.removeAlbum((String) resultList.getSelectedValue());
       System.out.println(accessObject.removeAlbum((String) resultList.getSelectedValue()));
       populateList(accessObject.listAlbumTitles());
       albumDataTable.setModel(defaultAlbumModel);
    ...
    private void insertStudioButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertStudioButtonActionPerformed
       ArrayList<String> studioData = new ArrayList<>();

       for (int i = 0; i < 4; i++) {
          studioData.add(((StudioTableModel) studioDataTable.getModel()).
          getValueAt(0, i).toString());
       }
       String result = accessObject.insertStudio(studioData, "Musicland Studios");
